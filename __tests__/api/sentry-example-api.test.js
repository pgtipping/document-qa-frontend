...
describe("Sentry Example API Route", () => {
    ...
    it("should handle errors and capture them in Sentry", async () => {
        ...
        expect(Sentry.captureException).toHaveBeenCalledWith(new Error("Sentry Example API Route Error"), {
            tags: {
    ...
    it("should handle performance monitoring configuration", async () => {
        ...
        expect(Sentry.startSpan).toHaveBeenCalledWith(expect.objectContaining({
            name: "Test API Error",
        }), expect.any(Function));
    });

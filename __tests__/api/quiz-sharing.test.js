...
describe("Quiz Sharing API", () => {
    ...
    it("should enable sharing for a quiz result", async () => {
        ...
        prisma.quizResult.update.mockResolvedValue(mockSharedResult);
        // Create mock request
    ...
    it("should disable sharing for a quiz result", async () => {
        ...
        prisma.quizResult.update.mockResolvedValue(mockPrivateResult);
        // Create mock request
        const request = createMockRequest({
            resultId: "result123",
            isShared: false,
    ...
    it("should handle database errors gracefully", async () => {
        // Mock database error
        prisma.quizResult.update.mockRejectedValue(new Error("Database connection error"));
        // Create mock request
        const request = createMockRequest({
            resultId: "result123",
            isShared: true,

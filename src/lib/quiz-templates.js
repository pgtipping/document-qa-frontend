...
export const quizTemplates = [
    {
        ...
        description: "Balanced mix of questions covering the main points of any document type",
        documentTypes: ["any"],
        icon: "Book",
        promptModifier: "Focus on the main concepts and key facts presented in the document.",
        questionTypes: {
            multipleChoice: 60,
            trueFalse: 20,
            shortAnswer: 20,
    ...
    },
    {
        id: "academic",
        name: "Academic Paper",
        description: "Specifically designed for scholarly articles and research papers",
        documentTypes: ["research", "academic", "scientific"],
        icon: "GraduationCap",
        promptModifier: "Focus on the methodology, findings, and implications of the research presented. Include questions about the experimental design, data analysis, and conclusions.",
        questionTypes: {
            multipleChoice: 50,
            trueFalse: 20,
            shortAnswer: 30,
    ...
    },
    {
        ...
        icon: "Code",
        promptModifier: "Focus on technical specifications, procedures, and implementation details. Favor precision and technical accuracy in the questions.",
        questionTypes: {
            multipleChoice: 70,
            trueFalse: 20,
            shortAnswer: 10,
    ...
    },
    {
        ...
        icon: "BarChart",
        promptModifier: "Focus on business metrics, strategies, market analysis, and financial implications. Include questions about business processes and strategic decisions.",
        questionTypes: {
            multipleChoice: 50,
            trueFalse: 20,
            shortAnswer: 30,
    ...
    },
    {
        ...
        icon: "BookOpen",
        promptModifier: "Focus on plot elements, character analysis, themes, and literary devices. Ask questions that probe understanding of the narrative structure and authorial intent.",
        questionTypes: {
            multipleChoice: 40,
            trueFalse: 20,
            shortAnswer: 40,
 ...
 */
export function getRecommendedTemplates(filename) {
    ...
    // Technical documents
    if (lowerFilename.includes("technical") ||
